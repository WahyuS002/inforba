...
<div class="mt-28 px-60">
    ...
    <div class="mt-6 flex justify-center space-x-4 font-semibold font-montserrat text-sm">
        ...
        <div class="flex items-center space-x-2 bg-red-light px-2 rounded-sm">
            <span>
...
<div class="mt-12 flex space-x-12">
    <div class="w-3/5 border border-violet-light rounded-md">
        <img alt="Placeholder" class="block h-auto w-full p-3 rounded-md" src="https://picsum.photos/600/400/?random"/>
    </div>
    <div class="w-2/5 p-3 border border-violet-light rounded-md">
...
<!-- END CARD SECTION -->
<div class="mt-12">
    <h4 class="font-montserrat font-bold text-2xl text-violet-middle">Deskripsi</h4>
    <span class="mt-12 font-semibold text-violet-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero voluptatem laudantium debitis adipisci officiis, velit sed eos eveniet optio dolor voluptas voluptates nam, qui incidunt obcaecati, recusandae vero quas dolores?</span>
</div>
@endsection