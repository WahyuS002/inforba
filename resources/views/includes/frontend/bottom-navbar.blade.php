...
<div class="w-full md:hidden">
    <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-green-light shadow">
        <div id="tabs" class="flex justify-between">
            <a href="#" class="w-full justify-center inline-block text-center pt-2 pb-1 text-violet-dark">
            ...
            <a href="#" class="w-full justify-center inline-block text-center pt-2 pb-1 text-violet-light">
