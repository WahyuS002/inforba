<header class="mt-10 flex justify-between">
    ...
    <div class="w-4/12 relative">
        <input class="w-full rounded-lg border-2 border-violet-middle px-5 py-1 focus:outline-none font-montserrat text-violet-middle" placeholder="Cari Lomba..."/>
    ...
    <div class="flex items-center space-x-8">
        ...
        <span class="w-7 h-7 rounded-full bg-black cursor-pointer">
            <img src="" alt="" />
        </span>
    </div>
    @endauth
